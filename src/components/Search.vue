...
const isRecent = ref(localStorage.getItem('isRecent') === 'true')
...
<template>
  ...
  <div class="mt-3 md:mt-5" v-if="isRecent">
    ...
    <div class="flex mt-3 flex-wrap h-12 overflow-auto">
      <div
        class="flex items-center m-1 text-zinc-100/20 md:m-2"
